...
return(
    <div>
        <img src="6-removebg-preview.png"className="-top-10 -z-10 absolute"/>
        ...
        <img src="5-removebg-preview.png"className="  -bottom-20 -z-10 absolute"/>
        <img src="7-removebg-preview.png"className=" -right-80 bottom-20 -z-10 absolute"/>
